...
| **2.6.0** (minor) | M8 — units 00 ✅, 01 ✅, 02 ✅, 03 ✅, then 04, 06, 07, and 05 last. **Unit 06 is release-blocking**: without it 2.6.0 publishes a JSON format whose `iso` is null for everyone who installs the tool. | In progress |
